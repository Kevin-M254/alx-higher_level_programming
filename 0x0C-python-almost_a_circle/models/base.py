...
class Base:
    ...
    def to_json_string(list_dictionaries):
        """Return the JSON serialization of alist of dicts.
    ...
    def create(cls, **dictionary):
        """Return a class instatiated from a dictionary of attributes.
    ...
    def load_from_file(cls):
        """Returns a list of classes instatiated from a file of JSON strings.
    ...
    def load_from_file_csv(cls):
        """Return a list of classes instatiated from CSV file.

        Reads from `<cls__name__>.csv`.
